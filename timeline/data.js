...
window.TIMELINE = {
  ...
  // ---------------------------------------------------------------------------
  // Machine photographs in media/machines/, all from Wikimedia Commons; the
  // credit and licence show on hover. credits.md there is the human-readable list.
  // ---------------------------------------------------------------------------
  photos: {
    "professional-iris": { file: "media/machines/professional-iris.jpg", credit: "Brad Montgomery", license: "CC BY 2.0", url: "https://commons.wikimedia.org/wiki/File:SGI_Professional_IRIS_(1).jpg" },
    "personal-iris": { file: "media/machines/personal-iris.jpg", credit: "Andy Diller", license: "CC BY-SA 2.0", url: "https://commons.wikimedia.org/wiki/File:SGI_Personal_Iris_(1).jpg" },
    "indigo": { file: "media/machines/indigo.jpg", credit: "Retro-Computing Society of Rhode Island", license: "CC BY-SA 3.0", url: "https://commons.wikimedia.org/wiki/File:SGI-indigo-front.jpg" },
    "indigo2": { file: "media/machines/indigo2.jpg", credit: "unicron1bot", license: "CC BY 2.0", url: "https://commons.wikimedia.org/wiki/File:SGI_Indigo2_(1).jpg" },
    "onyx": { file: "media/machines/onyx.jpg", credit: "Retro-Computing Society of Rhode Island", license: "CC BY-SA 4.0", url: "https://commons.wikimedia.org/wiki/File:SGI-onyx.jpg" },
    "indy": { file: "media/machines/indy.jpg", credit: "Wall\u00e9n, Peter", license: "CC BY 3.0", url: "https://commons.wikimedia.org/wiki/File:SGI_Indy_(1).jpg" },
    "o2": { file: "media/machines/o2.jpg", credit: "Rama & Mus\u00e9e Bolo", license: "CC BY-SA 2.0 fr", url: "https://commons.wikimedia.org/wiki/File:SGI_O2-IMG_7208.jpg" },
    "onyx2-origin": { file: "media/machines/onyx2-origin.jpg", credit: "Wolfgang Stief", license: "CC0", url: "https://commons.wikimedia.org/wiki/File:SGI_Onyx_2_(x2)_%2B_Origin_2000.jpg" },
    "octane": { file: "media/machines/octane.jpg", credit: "Afrank99 (talk)", license: "CC BY-SA 2.0", url: "https://commons.wikimedia.org/wiki/File:SgiOctane.jpg" },
    "fuel": { file: "media/machines/fuel.jpg", credit: "Rules666", license: "CC BY-SA 4.0", url: "https://commons.wikimedia.org/wiki/File:SGI_Fuel_Front.jpg" },
    "tezro": { file: "media/machines/tezro.jpg", credit: "Andy Diller", license: "CC BY-SA 2.0", url: "https://commons.wikimedia.org/wiki/File:SGI_Tezro.jpg" }
  },
  ...
  eras: [
    { id: "gl1", name: "IRIS 1000 series", short: "GL1", start: "1983-11", end: "1985-08",
      ...
      blurb: "SGI's first products: the IRIS 1000 graphics terminal for a host VAX, then the IRIS 1400 workstation. GL1 is the first Graphics Library. Gary Tarolli's flight 1.0 ships here." },
    ...
    { id: "irix3", photo: "personal-iris", name: "IRIS 4D and IRIX 3", short: "IRIX 3", start: "1987-03", end: "1991-09",
    ...
    { id: "irix4", photo: "indigo", name: "IRIX 4", short: "IRIX 4", start: "1991-09", end: "1993-03",
    ...
    { id: "irix5", photo: "indy", name: "IRIX 5", short: "IRIX 5", start: "1993-03", end: "1994-08",
    ...
    { id: "irix6", photo: "o2", name: "IRIX 6.0 to 6.4", short: "IRIX 6", start: "1994-08", end: "1998-06",
    ...
    { id: "irix65", photo: "fuel", name: "IRIX 6.5", short: "6.5", start: "1998-06", end: "2006-08",
  ...
  events: [
    ...
    { id: "ipo", date: "1986", kind: "corporate", title: "SGI goes public", sources: ["https://en.wikipedia.org/wiki/Silicon_Graphics"] },
    { id: "4d60", photo: "professional-iris", date: "1987-03", chart: "4D/60", kind: "hardware", title: "Professional IRIS 4D/60", text: "The first MIPS IRIS (R2000, Clover1 graphics), running 4D1-1.0. The 4D/70 follows in November 1987; the 4D/70GT with Clover2 in 1988.", sources: ["http://www.sgistuff.net/hardware/systems/professional.html"] },
    ...
    { id: "pi-4d35", photo: "personal-iris", date: "1991-04", kind: "hardware", title: "Personal IRIS 4D/35", text: "R3000 Personal IRIS; the last of the 4D line.", sources: ["http://www.sgistuff.net/hardware/systems/personal.html"] },
    { id: "indigo", photo: "indigo", date: "1991-07-22", chart: "Indigo", kind: "hardware", title: "IRIS Indigo", text: "The R3000 Indigo; the first of the IRIX 4 machines. Express graphics (XS, Elan) follow in 1992.", sources: ["https://en.wikipedia.org/wiki/SGI_Indigo"] },
    ...
    { id: "indigo2", photo: "indigo2", date: "1993-01-26", kind: "hardware", title: "Indigo2, Onyx, and Challenge", text: "R4000 desksides and the RealityEngine2 Onyx.", sources: ["https://en.wikipedia.org/wiki/SGI_Indigo2", "https://en.wikipedia.org/wiki/SGI_Onyx"] },
    ...
    { id: "indy", photo: "indy", date: "1993-07-12", chart: "Indy", kind: "hardware", title: "Indy", text: "R4000 desktop with a camera, shipping with IRIX 5.1 and the Indigo Magic desktop.", sources: ["https://en.wikipedia.org/wiki/SGI_Indy"] },
    ...
    { id: "o2", photo: "o2", date: "1996-10-07", chart: "O2", kind: "hardware", title: "O2, Origin 2000, Onyx2", text: "Announced together. The O2 case's dark blue is this site's palette. Octane follows on 27 January 1997.", sources: ["https://en.wikipedia.org/wiki/SGI_O2"] },
    ...
    { id: "irix-65", photo: "octane", date: "1998-06", chart: "6.5", kind: "os", title: "IRIX 6.5", text: "Demos now live on separate General and Platform Demos CDs; buttonfly is still the front end on the 6.5.12 discs. Flight's 6.5 man page credits Rob Mace, Thad Beier, Marc Ondrechen, and Marshall Levine.", sources: ["https://ryan.thoryk.com/sgi/irix_versions.html", "https://jrra.zone/sgi/"] },
    ...
    { id: "irix-6530", photo: "tezro", date: "2006-08-16", chart: "6.5.30", kind: "os", title: "IRIX 6.5.30", text: "The last IRIX release; MIPS and IRIX end of life is announced on 6 September 2006.", sources: ["https://ryan.thoryk.com/sgi/irix_versions.html"] },
  ...
  // ---------------------------------------------------------------------------
  people: {
    tarolli:  { name: "Gary Tarolli", note: "One of SGI's first graphics engineers, about ten years at SGI; wrote the original flight and dog. Later Pellucid and, in 1994, co-founder of 3dfx." },
  ...
  demos: [
    { id: "flight-1988", title: "Flight", subtitle: "the 1988 demo-tape flight, version 2.4",
      ...
      written: { date: "1984", note: "version 1.0 shipped on the IRIS 1400 in 1984, and flight 3.4's copyright runs from 1984; this source is the 1988 to 1989 revision" },
      edited: { date: "1989-02-07", note: "flight.h and uflight.c on the demo tape" },
      shipped: [
        { on: "IRIS 1400", date: "1984", how: "flight 1.0, 68k binary", note: "a version 1.0 executable survives; see the archive table" },
        { on: "IRIS 2000 and 3000", date: "1987-05", how: "flight, dog, radar, and shadow on the list of demo sources customers could request, IRIS Universe, spring 1987" },
      ...
      history: [
        "Flight is the oldest program on exhibit. Gary Tarolli wrote it, and dog with it: \"I wrote the original flight/dog programs,\" he said on comp.sys.sgi in 1989 [1]. Version 1.0 shipped with the IRIS 1400 in 1984, and a 68k executable of it survives [4]; the pair were on SGI's list of demo sources customers could request by the spring of 1987 [6]. By December 1988 dog ran over UDP broadcast on port 5130, sgi-dogfight in /etc/services [2]. Tarolli's own telling of the early years is in his 2013 Computer History Museum oral history [5].",
        "The demo-tape source of 1988 to 1989 is the version 2.4 lineage rebuilt for the 4D: colour-index mode, flat shading, a painter's-algorithm depth sort, and meters drawn by masking bitplanes [3]. By then Rob Mace owned the code [2]; Tarolli wrote in the same February 1989 post that the planes were half real and half there to make dog fun, that the threat cones and HUD were built for Williams Air Force Base, and that airshow recording (dog -o) was meant for flying against yourself [1]. The banner still reads the unsubstituted \"Version vnum\"; this source never numbered itself [3]."
      ],
      sources: [
